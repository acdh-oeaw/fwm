    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight', models.DecimalField(blank=True, decimal_places=10, help_text='weight of the sample', max_digits=19, null=True, verbose_name='weight')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mgco3', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for mgco3', max_digits=19, null=True, verbose_name='MgCO3')),
                ('fe', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for fe', max_digits=19, null=True, verbose_name='Fe')),
                ('mn', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for mn', max_digits=19, null=True, verbose_name='Mn')),
                ('sr', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for sr', max_digits=19, null=True, verbose_name='Sr')),
                ('ion_li', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_li', max_digits=19, null=True, verbose_name='Li')),
                ('ion_na', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_na', max_digits=19, null=True, verbose_name='Na')),
                ('ion_k', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_k', max_digits=19, null=True, verbose_name='K')),
                ('ion_mg', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_mg', max_digits=19, null=True, verbose_name='MgCO3')),
                ('ion_ca', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_ca', max_digits=19, null=True, verbose_name='Ca')),
                ('ion_f', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_f', max_digits=19, null=True, verbose_name='Fe')),
                ('ion_cl', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_cl', max_digits=19, null=True, verbose_name='Cl')),
                ('ion_br', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_br', max_digits=19, null=True, verbose_name='Br')),
                ('ion_j', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_j', max_digits=19, null=True, verbose_name='J')),
                ('ion_no3', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_no3', max_digits=19, null=True, verbose_name='NO3')),
                ('ion_so4', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_so4', max_digits=19, null=True, verbose_name='SO4')),
                ('ion_li_na', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_li_na', max_digits=19, null=True, verbose_name='Li/Na')),
                ('ion_k_na', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_k_na', max_digits=19, null=True, verbose_name='K/Na')),
                ('ion_cl_na', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_cl_na', max_digits=19, null=True, verbose_name='Cl/Na')),
                ('ion_br_na', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_br_na', max_digits=19, null=True, verbose_name='Br/Na')),
                ('ion_i_na', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_i_na', max_digits=19, null=True, verbose_name='I/Na')),
                ('ion_so4_na', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_so4_na', max_digits=19, null=True, verbose_name='SO4/Na')),
                ('ion_f_na', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_f_na', max_digits=19, null=True, verbose_name='F/Na')),
                ('ion_no3_na', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for ion_no3_na', max_digits=19, null=True, verbose_name='NO3/Na')),
                ('iso_d18o', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for iso_d18o', max_digits=19, null=True, verbose_name='d18O (PDB)')),
                ('iso_d13c', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for iso_d13c', max_digits=19, null=True, verbose_name='D13c (PDB)')),
                ('icp_mg', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_mg', max_digits=19, null=True, verbose_name='Mg')),
                ('icp_mn', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_mn', max_digits=19, null=True, verbose_name='Mn')),
                ('icp_fe', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_fe', max_digits=19, null=True, verbose_name='Fe')),
                ('icp_sr', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_sr', max_digits=19, null=True, verbose_name='Sr')),
                ('icp_cr', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_cr', max_digits=19, null=True, verbose_name='Cr')),
                ('icp_cr_n2o', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_cr_n2o', max_digits=19, null=True, verbose_name='Cr (N2O)')),
                ('icp_v', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_v', max_digits=19, null=True, verbose_name='V')),
                ('icp_y', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_y', max_digits=19, null=True, verbose_name='Y')),
                ('icp_cd', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_cd', max_digits=19, null=True, verbose_name='Cd')),
                ('icp_ba', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_ba', max_digits=19, null=True, verbose_name='Ba')),
                ('icp_la', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_la', max_digits=19, null=True, verbose_name='La')),
                ('icp_ce', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_ce', max_digits=19, null=True, verbose_name='Ce')),
                ('icp_pr', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_pr', max_digits=19, null=True, verbose_name='Pr')),
                ('icp_dy', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_dy', max_digits=19, null=True, verbose_name='Dy')),
                ('icp_ho', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_ho', max_digits=19, null=True, verbose_name='Ho')),
                ('icp_yb', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_yb', max_digits=19, null=True, verbose_name='Yb')),
                ('icp_pb', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_pb', max_digits=19, null=True, verbose_name='Pb')),
                ('icp_u', models.DecimalField(blank=True, decimal_places=10, help_text='helptext for icp_u', max_digits=19, null=True, verbose_name='U')),
                ('orig_data_csv', models.TextField(blank=True, null=True, verbose_name='The original data')),
