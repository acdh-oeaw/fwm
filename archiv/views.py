...
from .forms import (
    AnalyseFilterFormHelper,
    AnalyseForm,
    ArtifactFilterFormHelper,
    ArtifactForm,
    GeographyFilterFormHelper,
    GeographyForm,
    InstitutionFilterFormHelper,
    InstitutionForm,
    NumberFilterFormHelper,
    NumberForm,
    ProjectFilterFormHelper,
    ProjectForm,
    QuarryFilterFormHelper,
    QuarryForm,
    QuarryGroupFilterFormHelper,
    QuarryGroupForm,
    SampleFilterFormHelper,
    SampleForm,
)
from .models import (
    Analyse,
...
def export_zip(request):
    ...
    with zipfile.ZipFile(zip_buffer, "w", zipfile.ZIP_DEFLATED) as zip_file:
        ...
        # Institution
        institution_ergebnisse = Institution.objects.filter(Q(name__icontains=query))
        write_csv_to_zip(
...
class AnalyseListView(GenericListView):
    ...
    init_columns = ["id", "oeai_inventory_number", "analyse_type"]
    ...
    exclude_columns = [
        ...
        "epr_spli_standardisedepr_w_standardised",
...
class GeographyListView(GenericListView):
    ...
    init_columns = ["id", "name", "identifier"]
    ordering = ["id"]
    enable_merge = False
...
class NumberListView(GenericListView):
    ...
    init_columns = ["id", "id", "number", "number_type", "oeai_inventory_number"]
    enable_merge = False
