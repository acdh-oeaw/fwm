...
class ContactFormView(FormView):
    ...
    def form_valid(self, form):
        ...
        if sheet == 'sample':
            ...
            for row in reader:
                vocab_material, _ = SkosConcept.objects.get_or_create(pref_label=row['material_id'].strip())
                vocab_color, _ = SkosConcept.objects.get_or_create(pref_label=row['color'].strip())
                vocab_smell, _ = SkosConcept.objects.get_or_create(pref_label =row['smell'].strip())
                vocab_grain_max, _ = SkosConcept.objects.get_or_create(pref_label =row['grain_max'].strip())
                vocab_grain_min, _ = SkosConcept.objects.get_or_create(pref_label =row['grain_min'].strip())
                vocab_license, _ = SkosConcept.objects.get_or_create(pref_label=row['license'].strip()) 
